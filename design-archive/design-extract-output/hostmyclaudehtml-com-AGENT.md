# You are building UI in the hostmyclaudehtml.com design system.

Source: https://hostmyclaudehtml.com/p/_Y67ztwQOo
Extracted by designlang on 2026-05-23.
...
- primary     #111827
- secondary   #f97316
- neutrals    #e5e7eb · #0f1114 · #6b7280 · #000000 · #4b5563 · #ffffff
...
- scale      1px · 32px · 40px · 46px · 57px · 64px · 80px · 96px · 128px · 136px · 141px · 160px

## Radii

- scale      2px · 8px · 11px · 15px · 24px · 32px
...
```bash
npx designlang hostmyclaudehtml.com
```
...
Generated by designlang. Re-extract by running `npx designlang hostmyclaudehtml.com`.
