...
description: Use when styling UI for open.fusionconnectgroup.com — references the extracted design system tokens instead of inventing colors, spacing, or typography.
---
