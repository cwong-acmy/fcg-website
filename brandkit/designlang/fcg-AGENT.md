# You are building UI in the fusionconnectgroup.com design system.
...
- title         FCG Group - Travel Infrastructure
- page intent   landing
- material      flat
- design grade  C
...
- primary     #f97316
- secondary   #111827
- neutrals    #e5e7eb · #0f1114 · #6b7280 · #4b5563 · #000000 · #d1d5db

## Typography

- families   Inter
- weights    400 · 300 · 500 · 600 · 700
- base size  16px

## Spacing

- scale      1px · 40px · 48px · 64px · 80px · 96px · 128px · 141px · 160px · 170px · 213px

## Radii

- scale      2px · 6px · 11px · 15px · 24px · 32px

## Motion

- durations  75ms · 100ms · 180ms · 300ms
...
- headings   Title Case
- CTA verbs  get · products · network
...
```bash
npx designlang fusionconnectgroup.com
```
...
Generated by designlang. Re-extract by running `npx designlang fusionconnectgroup.com`.
